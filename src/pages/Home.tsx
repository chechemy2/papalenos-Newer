  ...
  const timelineData = [
      ...
      content: (
        <div className="bg-white p-6 rounded-lg shadow-md">
          <p className="text-gray-700 mb-4">
            The Paplenos restaurant was founded and opened in 1984 in the heart of Berea.
          </p>
          <img 
    ...
    },
    {
      ...
      content: (
        <div className="bg-white p-6 rounded-lg shadow-md">
          <p className="text-gray-700 mb-4">
            Papalenos was bought by the current management duo, Brad and Jerome Lewis, in 1998, as the restaurant was a staple in Berea.
          </p>
          <img 
            src="/assets/time 2.jpg" 
    ...
    },
    {
      ...
      content: (
        <div className="bg-white p-6 rounded-lg shadow-md">
          <p className="text-gray-700 mb-4">
            Today, Papalenos proudly serves fresh, delicious food to the residents of Berea and warmly welcomes travelers to stop by!
          </p>
          <img 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-700 max-w-3xl mx-auto">
              For over 40 years, we've been serving authentic Italian cuisine made with love and the finest ingredients. 
