        ...
        <div className="md:flex items-center">
          <div className="md:w-1/2 mb-8 md:mb-0 md:pr-12">
            ...
            <p className="text-gray-700 mb-4">
              Papalenos Italian Restaurant was founded in 1984 by Giuseppe and Maria Papaleno, who immigrated to America from Sicily with a dream of sharing their family's culinary traditions.
            </p>
            <p className="text-gray-700 mb-4">
          ...
          <div className="md:flex items-center">
            <div className="md:w-2/3 mb-6 md:mb-0 md:pr-8">
              ...
              <p className="text-gray-200 mb-4">
                At Papalenos, we believe in giving back to the community that has supported us for over four decades. We regularly participate in local events, sponsor youth sports teams, and donate meals to those in need.
              </p>
              <p className="text-gray-200 mb-4">
